...
export default function LookPage(props) {
    ...
    const print = () => {
        window.document.body.innerHTML = window.document.getElementById('print_area').innerHTML
        window.print()
    ...
    const { total, TBL_RepairOrder = {}, TBL_Vehicleselect = {}, TBL_VehicleOwner = {}, TBL_ManHourExpense = [], TBL_RepairPartItem = [], Corporation = {} } = data
        ...
        <>
            ...
            >
                ...
                <div style={{ marginLeft: '24px' }}>
                    <span style={{ width: '90px', display: 'inline-block' }}>客户地址</span>
                    <span>青嘉乡文昌宫村五社</span>
                </div>
                <div style={{ marginLeft: '24px' }}>
                ...
                <div style={{ marginTop: '24px' }}>
                    <Table columns={tableColumns} dataSource={TBL_ManHourExpense} pagination={false} />
                </div>
                <Divider style={{ borderTop: '1px solid', margin: '24px 0' }} />
                <div style={{ marginTop: '24px' }}>
                    <Table columns={tableColumns_two} dataSource={TBL_RepairPartItem} pagination={false} />
                </div>
                <Divider style={{ borderTop: '1px solid', margin: '20px 0' }} />
                <div className="card_info_two" style={{ padding: '0 24px' }}>
                    <div className="card_info_two_sub" style={{ width: '25%', display: 'inline-block' }}>
                        <div>
                            <span className="label" style={{ width: '120px', display: 'inline-block' }}>
                                1.预估工时费
                            </span>
                ...
                <div className="tootip" style={{ paddingLeft: '24px' }}>
                    ...
                    <p>2.随车贵重物品请客户自行保管，如有遗失，本单位不承担任何责任。3.如有涉及保修事项按《保修及保养手册》执行。</p>
