...
export default function OrderList(props) {
    ...
    const columns = [
        { title: '工单号', dataIndex: 'RepairOrderCode', key: '1', align: 'center' },
                    ...
                    <>
                        {lookData ? (
                            <Button
                                type="primary"
                                onClick={() => {
                                    props.history.push(`/searchList/lookPage/${record.RepairOrderCode}`)
                                }}
                            >
                                查看
                            </Button>
        ...
        <div>
            ...
            {lookData ? (
                <Form form={form} initialValues={initialValues}>
                    <Form.Item name="time" style={{ display: 'inline-block', marginRight: '5px' }}>
                        <Select style={{ width: '90px' }}>
                            <Option value={''}>请选择</Option>
