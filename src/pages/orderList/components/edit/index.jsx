            ...
            setDataSourceMeal([
                {
                    ...
                    SellSum: getNumValue(parseFloat(record?.SellPrice1) * parseFloat(record?.Quantity)),
                },
                ...dataSourceMeal,
            ])
        }
